...
var sshinfo = "When you have been granted access to NYU Hosting, you will receive an email with SSH/FTP credentials with the subject line, \"New Account Information.\" Accessing the server/backend can be useful if you have to transfer many files over to your server space quickly using an FTP program. You can also access the backend via the cPanel.<br><br>";

var signoff ="Best,<br>NYU DSS and Web Hosting"
...
$(document).ready(function() {
  $("#submit").click(function() {
    ...
    if ('temp' in data) { result += temp_preface }
    else { result += notemp_preface }
    result += login + accessibility;
